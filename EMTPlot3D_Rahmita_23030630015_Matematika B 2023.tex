...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)",-5,5,0,6*pi):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-002.png}
\begin{eulercomment}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-009.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-011.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-012.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-013.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-015.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-016.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-022.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-028.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-029.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-030.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-031.png}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-037.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-038.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-043.png}
...
sesuaikan x dan y, sehingga vektor-vektornya terpusat pada nilai yang
digunakan.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-046.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-047.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-048.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-052.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Size 1 x 101 not acceptable in solid plots
  plotcontourplane:
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-054.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTPlot3D-055.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-057.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-058.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-059.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMTPlot3D-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMTPlot3D-062.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-063.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-064.png}
...
>povend;
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-065.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-066.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-067.png}
...
lateks: ((x\textasciicircum{}2+y\textasciicircum{}2-c\textasciicircum{}2)\textasciicircum{}2+(z\textasciicircum{}2-1)\textasciicircum{}2)*((y\textasciicircum{}2+z\textasciicircum{}2-c\textasciicircum{}2)\textasciicircum{}2+(x\textasciicircum{}
2-1)\textasciicircum{}2)*((z\textasciicircum{}2+x\textasciicircum{}2-c\textasciicircum{}2)\textasciicircum{}2+(y\textasciicircum{}2-1)\textasciicircum{}2)=d
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-068.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-069.png}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-070.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-072.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{18}{images/EMTPlot3D-073.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMTPlot3D-074.png}
