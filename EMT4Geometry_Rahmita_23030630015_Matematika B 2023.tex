...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-002.png}
\begin{eulerprompt}
>B=[0,1]; plotPoint(B,"B"):
\end{eulerprompt}
...
>C=[2,2]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-004.png}
\begin{eulercomment}
Lalu tiga segmen.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-009.png}
\begin{eulercomment}
Rencanakan itu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-010.png}
\begin{eulerprompt}
>aspect(1); plotSegment(A,D): // tampilkan semua gambar hasil plot...()
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-011.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-012.png}
\begin{eulerprompt}
>R=getCircleRadius(c): // jari2 lingkaran luar 
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-013.png}
\begin{eulerprompt}
>O=getCircleCenter(c): // titik pusat lingkaran c 
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-014.png}
\begin{eulerprompt}
>plotPoint(O,"O"): // gambar titik "O"
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-015.png}
\begin{eulerprompt}
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-017.png}
\begin{eulerprompt}
>g=angleBisector(C,A,B): // garis bagi <CAB
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-018.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-019.png}
\begin{eulerprompt}
>plotPoint(P,"P"): // gambar titik potongnya
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-020.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-021.png}
\begin{eulercomment}
**Latihan

1. Tentukan titik ketiga singgung lingkaran dalam dengan sisi-sisi
segitiga ABC.\\
2. Gambar segitiga dengan titik-titik sudut ketiga titik singgung
tersebut. Merupakan segitiga apakah itu?\\
3. Hitung luas segitiga tersebut.\\
4. Tidak ada garis bagi sudut yang ke tiga juga melalui titik pusat
lingkaran dalam.\\
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-022.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-024-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-026-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-032-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-036.png}
\begin{eulerprompt}
>B &:= [1,2]; C &:= [2,1]; l=lineThrough(B,C):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-037.png}
\begin{eulerprompt}
>setPlotRange(5); plotCircle(c); plotLine(l):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-039.png}
\begin{eulerprompt}
>P1, P2, f
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-042.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-043.png}
\begin{eulerprompt}
>degprint(computeAngle(P1,C,P2))
\end{eulerprompt}
\begin{euleroutput}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-044.png}
...
>A=[2,2]; B=[-1,-2]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-045.png}
\begin{eulerprompt}
>c1=circleWithCenter(A,distance(A,B)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-046.png}
\begin{eulerprompt}
>c2=circleWithCenter(B,distance(A,B)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-047.png}
\begin{eulerprompt}
>\{P1,P2,f\}=circleCircleIntersections(c1,c2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-048.png}
\begin{eulerprompt}
>l=lineThrough(P1,P2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-049.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-051.png}
\begin{eulercomment}
...
>A &= [a1,a2]; B &= [b1,b2]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-052.png}
\begin{eulerprompt}
>c1 &= circleWithCenter(A,distance(A,B)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-053.png}
\begin{eulerprompt}
>c2 &= circleWithCenter(B,distance(A,B)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-054.png}
\begin{eulerprompt}
>P &= circleCircleIntersections(c1,c2); P1 &= P[1]; P2 &= P[2]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-056.png}
\begin{eulerprompt}
>$solve(g,y)
\end{eulerprompt}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulercomment}
This is indeed the same as the middle perpendicular, which is computed
in a completely different way.Ini memang sama dengan garis tengah
tegak lurus, yang dihitung dengan cara yang sangat berbeda.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-059.png}
\begin{eulerprompt}
>$solve(h,y)
\end{eulerprompt}
\begin{eulerformula}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-061.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-063.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-067-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-068.png}
\begin{eulercomment}
Kita dapat memeriksa persamaan umum elips ini, yaitu.

lateks: \textbackslash{}frac\{(x-x\_m)\textasciicircum{}2\}\{u\textasciicircum{}2\}+\textbackslash{}frac\{(y-y\_m)\}\{v\textasciicircum{}2\}=1,
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-073-large.png}
\begin{eulercomment}
...
lateks: \textbackslash{}frac\{a\}\{\textbackslash{}sin(\textbackslash{}alpha)\}=2r

untuk radius. Kita bisa cek, apakah hal tersebut memang benar terjadi
pada Maxima. Maxima akan memfaktorkan ini hanya jika kita
mengkuadratkannya.
\end{eulercomment}
\begin{eulerprompt}
...
>A::=[-1,-1]; B::=[2,0]; C::=[1,2]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-076.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-077.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-082-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-095.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-097.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-098.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-101-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-104-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-105.png}
\begin{eulercomment}
Tentu saja,

lateks: \textbackslash{}sin(w\_a)=\textbackslash{}frac\{a\}\{c\},
...
lateks: (c+b-a)\textasciicircum{}2 = 4 b c \textbackslash{}, (1-s\_a)
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-110-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-114.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-117-large.png}
\eulerimg{0}{images/EMT4Geometry-118-large.png}
\begin{eulercomment}
...
lateks: A=\textless{}1,2\textgreater{}\textbackslash{}quad B=\textless{}4,3\textgreater{},\textbackslash{}quad C=\textless{}0,4\textgreater{}\\
lateks: \textbackslash{}mathbf\{a\}=C-B=\textless{}-4,1\textgreater{},\textbackslash{}quad \textbackslash{}mathbf\{c\}=A-B=\textless{}-3,-1\textgreater{},\textbackslash{}quad
\textbackslash{}beta=\textbackslash{}angle ABC\\
lateks: \textbackslash{}mathbf\{a\}.\textbackslash{}mathbf\{c\}=\textbar{}\textbackslash{}mathbf\{a\}\textbar{}.\textbar{}\textbackslash{}mathbf\{c\}\textbar{}\textbackslash{}cos \textbackslash{}beta\\
lateks: \textbackslash{}cos \textbackslash{}angle ABC
=\textbackslash{}cos\textbackslash{}beta=\textbackslash{}frac\{\textbackslash{}mathbf\{a\}.\textbackslash{}mathbf\{c\}\}\{\textbar{}\textbackslash{}mathbf\{a\}\textbar{}.\textbar{}\textbackslash{}mathbf\{c\}\textbar{}\}=\textbackslash{}frac\{12
-1\}\{\textbackslash{}sqrt\{17\}\textbackslash{}sqrt\{10\}\}=\textbackslash{}frac\{11\}\{\textbackslash{}sqrt\{17\}\textbackslash{}sqrt\{10\}\}
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-121-large.png}
\begin{eulercomment}
...
lateks: s\_b=\textbackslash{}frac\{h\_a\}\{c\}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-129-large.png}
...
lateks: \textbackslash{}alpha+\textbackslash{}beta+\textbackslash{}gamma=\textbackslash{}pi

Sejak menyebarnya

lateks: \textbackslash{}alpha, \textbackslash{}pi-\textbackslash{}alpha

sama, aturan penyebaran tiga kali lipat juga benar, jika

lateks: \textbackslash{}alpha+\textbackslash{}beta=\textbackslash{}gamma

Karena penyebaran sudut negatifnya sama, maka aturan penyebaran tiga
kali lipat juga berlaku, jika

lateks: \textbackslash{}alpha+\textbackslash{}beta+\textbackslash{}gamma=0
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-133-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry-137-large.png}
\eulerimg{1}{images/EMT4Geometry-138-large.png}
\begin{eulercomment}
...
lateks: \textbackslash{}frac\{BC\}\{\textbackslash{}sin(w\_a)\} = \textbackslash{}frac\{AC\}\{\textbackslash{}sin(w\_b)\} =
\textbackslash{}frac\{AB\}\{\textbackslash{}sin(w\_c)\}
...
lateks: \textbackslash{}frac\{a\}\{s\_a\} = \textbackslash{}frac\{b\}\{s\_b\} = \textbackslash{}frac\{c\}\{s\_b\}
...
>A=[-1,-1]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-149.png}
\begin{eulerprompt}
>function d1(x,y):=sqrt((x-A[1])^2+(y-A[2])^2)
>fcontour("d1",xmin=-2,xmax=0,ymin=-2,ymax=0,hue=1, ...
>title="If you see ellipses, please set your window square"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-150.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-151.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-153.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-158.png}
\begin{eulercomment}
...
\eulerimg{27}{images/EMT4Geometry-171.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-172.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-173.png}
\begin{eulerprompt}
>writeln(povsphere([0,0,u[2]],dd[2],povlook(red))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-174.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-175.png}
\begin{eulercomment}
...
>gp=g():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-176.png}
\begin{eulerprompt}
>pc=povcone([0,0,0],0,[0,0,a],1,""):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-177.png}
\begin{eulerprompt}
>vp=[gp[1],0,gp[2]]; dp=gp[3]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-178.png}
\begin{eulerprompt}
>writeln(povplane(vp,dp,povlook(blue,0.5),pc)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-179.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-180.png}
\begin{eulerprompt}
>writeln(povpoint(P1,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-181.png}
\begin{eulerprompt}
>P2=projectToLine([0,u[2]],g1()); P2=turnz([P2[1],0,P2[2]]):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-182.png}
\begin{eulerprompt}
>writeln(povpoint(P2,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-183.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-184.png}
\begin{eulerprompt}
>writeln(povpoint(P3,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-185.png}
\begin{eulerprompt}
>P4=projectToLine([0,u[2]],g()); P4=[P4[1],0,P4[2]]:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-186.png}
\begin{eulerprompt}
>writeln(povpoint(P4,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-187.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-188.png}
\begin{eulerprompt}
>writeln(povpoint(P5,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-189.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-190.png}
\begin{eulerprompt}
>writeln(povsegment(P5,P3,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-191.png}
\begin{eulerprompt}
>writeln(povsegment(P5,P4,povlook(yellow))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-192.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-193.png}
\begin{eulerprompt}
>pc1=povcylinder([0,0,P1[3]-defaultpointsize/2],[0,0,P1[3]+defaultpointsize/2],1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-194.png}
\begin{eulerprompt}
>writeln(povintersection([pcw,pc1],povlook(gray))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-195.png}
\begin{eulerprompt}
>pc2=povcylinder([0,0,P2[3]-defaultpointsize/2],[0,0,P2[3]+defaultpointsize/2],1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-196.png}
\begin{eulerprompt}
>writeln(povintersection([pcw,pc2],povlook(gray))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-197.png}
\begin{eulercomment}
...
>povend():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-198.png}
\eulerimg{27}{images/EMT4Geometry-199.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-200.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-201.png}
\begin{eulerprompt}
...
jarak, keduanya dalam satuan radian. Untuk mendapatkan vektor, kita
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-202.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-203.png}
