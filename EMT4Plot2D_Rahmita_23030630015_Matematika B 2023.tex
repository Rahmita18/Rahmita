...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-001.png}
\begin{eulerprompt}
...
>plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-003.png}
\begin{eulerprompt}
...
>ow=window():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-005.png}
\begin{eulerprompt}
>window(xw,yw,xw+ww,yw+hw):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-006.png}
\begin{eulerprompt}
>hold on:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-007.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-010.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi):
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-011.png}
\begin{eulerprompt}
>aspect():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-012.png}
\begin{eulerprompt}
>reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-013.png}
\begin{eulercomment}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-014.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-015.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-016.png}
\begin{eulercomment}
...
>reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-020.png}
\begin{eulerprompt}
>figure(2,2); ...
>for n=1 to 4; figure(n); plot2d("x^"+n); end; ...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-021.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-033.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-035.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-037.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-039.png}
...
\begin{euleroutput}
  ...
  f:
      useglobal; return x^2/a+a*x^2-x:  
   %ploteval:
      y0=f$(x[1],args());
  adaptiveevalone:
      s=%ploteval(g$,t;args());
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-046.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-047.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-053.png}
\begin{eulerprompt}
>for i=1 to 10; plot2d("bin(10,i)*x^i*(1-x)^(10-i)",>add); end:
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-054.png}
\begin{eulerprompt}
>insimg:
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-055.png}
\eulerimg{17}{images/EMT4Plot2D-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-062.png}
\begin{eulercomment}
Alternatif lain adalah dengan menggunakan bahasa matriks Euler.
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-073.png}
...
\end{eulercomment}
\begin{eulerprompt}
>plot2d(\{\{"x^3-a*x",a=1\}\},>user,title="Press any key!")>draw:
\end{eulerprompt}
\begin{euleroutput}
  Variable draw not found!
  Error in:
  ... x^3-a*x",a=1\}\},>user,title="Press any key!")>draw: ...
                                                       ^
\end{euleroutput}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-077.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-078.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-079.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-080.png}
\begin{eulercomment}
...
>aspect():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-081.png}
\begin{eulerprompt}
>figure(3,4); ...
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-083.png}
\begin{eulerprompt}
...
>plot2d("exp(x)",-1,1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-085.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-095.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-099.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-102.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-103.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-105.png}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-106.png}
\begin{eulerprompt}
>figure(2); plot2d(x,y,r=10,>filled,style="/",fillcolor=red): // fill curve
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-107.png}
\begin{eulerprompt}
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-108.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-109.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-123.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-124.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-125.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-127.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-129.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-131.png}
\begin{eulerprompt}
>values=[10,12,12,18,22,28,30,26,22,18,12,8]:
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-132.png}
\begin{eulerprompt}
>columnsplot(values,lab=months,color=red,style="-"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-133.png}
\begin{eulerprompt}
>title("Temperature"):
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-136.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-154.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-155.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-156.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-157.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-158.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-159.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-160.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-161.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-162.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-172.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-174.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-175.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-176.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-177.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-178.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-179.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-180.png}
